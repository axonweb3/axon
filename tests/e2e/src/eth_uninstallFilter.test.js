...
const pageName = "eth_uninstallFilter.html";
beforeEach(async () => {
...
describe("eth_uninstallFilter", () => {
   ...
   */
  it("eth_uninstallFilter_1", async () => {
   ...
   */
  it("eth_uninstallFilter_2", async () => {
    const testType = await page.$(goto.pageIds.testTypeId);
    const param1 = await page.$(goto.pageIds.param1Id);
    await testType.type("1");
 ...
 */
  it("eth_uninstallFilter_3", async () => {
    await goto.goto(page, pageName);
    await page.click("#btn_filter");
    await page.waitForFunction(
      (id) => document.getElementById(id).innerText !== "",
  ...
  * param: none
  */
  it("eth_uninstallFilter_4", async () => {
    const testType = await page.$(goto.pageIds.testTypeId);
