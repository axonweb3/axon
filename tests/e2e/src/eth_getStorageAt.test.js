...
describe("Metamask", () => {
  ...
  */
  test("eth_getStorageAt_5", async () => {
    ...
    const param1 = await page.$(goto.pageIds.param1Id);
    const param2 = await page.$(goto.pageIds.param2Id);
    await testType.type("3");// 0: none params  1：common params to request   2: dvantage parameter
    await param1.type("0x8ab0CF264DF99D83525e9E11c7e4db01558AE1b1");
    await param2.type("0x0");
  ...
  */
  test("eth_getStorageAt_6", async () => {
    await goto.goto(page, pageName);
    const testType = await page.$(goto.pageIds.testTypeId);
    await testType.type("0");// 0: none params  1：common params to request   2: dvantage parameter
  ...
  */
  test("eth_getStorageAt_7", async () => {
    ...
    const param2 = await page.$(goto.pageIds.param2Id);
    const param3 = await page.$(goto.pageIds.param3Id);
    await testType.type("2");// 0: none params  1：common params to request   2: dvantage parameter
    await param1.type("0x8ab0CF264DF99D83525e9E11c7e4db01558AE1b1");
    await param2.type("0x0");
    await param3.type("latest");
