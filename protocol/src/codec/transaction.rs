...
mod tests {
    ...
    fn test_legacy_decode_with_chain_id() {
        ...
        assert!(tx.unsigned.data().is_empty());
        assert_eq!(*tx.unsigned.gas_limit(), U256::from(0x5208u64));
        assert_eq!(tx.unsigned.gas_price(), U256::from(0x02540be400u64));
        assert_eq!(*tx.unsigned.nonce(), U256::from(0x05u64));
        assert_eq!(
            tx.unsigned.to().unwrap(),
    ...
    fn test_legacy_decode_eip_1820() {
        ...
        assert_eq!(*tx.unsigned.gas_limit(), U256::from(0x0c3500u64));
        assert_eq!(tx.unsigned.gas_price(), U256::from(0x174876e800u64));
        assert_eq!(*tx.unsigned.nonce(), U256::from(0x00u64));
        assert_eq!(
            tx.unsigned.data(),
