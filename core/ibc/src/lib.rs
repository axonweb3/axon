    ...
    Adapter: IbcAdapter + 'static,
{
    fn client_type(&self, client_id: &ClientId) -> Result<ClientType, ClientError> {
        match self
            ...
            .read()
            .unwrap()
            .get_client_type(Context::new(), client_id)
        {
            Ok(Some(v)) => Ok(v),
    ...
    fn consensus_state(
        ...
        match self.adapter.read().unwrap().get_current_consensus_state(
            Context::new(),
            client_id,
            epoch,
            height,
    ...
    fn next_consensus_state(
        ...
        match self.adapter.read().unwrap().get_next_consensus_state(
            Context::new(),
            client_id,
            height,
        ) {
    ...
    fn prev_consensus_state(
        ...
        match self.adapter.read().unwrap().get_prev_consensus_state(
            Context::new(),
            client_id,
            height,
        ) {
    ...
    fn host_height(&self) -> ibc::Height {
        Height::new(0, self.adapter.read().unwrap().current_height()).unwrap()
    }
    ...
    Adapter: IbcAdapter + 'static,
{
    ...
    fn store_client_state(
        ...
        match self.adapter.write().unwrap().set_client_state(
            Context::new(),
            client_id,
            client_state,
        ) {
    ...
    fn store_consensus_state(
        ...
        match self.adapter.write().unwrap().set_consensus_state(
            Context::new(),
            client_id,
            height,
            consensus_state,
    ...
    Adapter: IbcAdapter + 'static,
{
    fn store_connection(
        ...
        match self.adapter.write().unwrap().set_connection_end(
            Context::new(),
            connection_id,
    ...
    fn store_connection_to_client(
        ...
        match self.adapter.write().unwrap().set_connection_to_client(
            Context::new(),
            connection_id,
            client_id.clone(),
        ) {
    ...
    Adapter: IbcAdapter + 'static,
{
    ...
    fn delete_packet_commitment(
        ...
        match self
            ...
            .write()
            .unwrap()
            .remove_packet_commitment(Context::new(), key)
        {
            Ok(_) => Ok(()),
            Err(_) => Err(ChannelError::implementation_specific()),
        }
    ...
    fn store_packet_acknowledgement(
        ...
        match self.adapter.write().unwrap().set_packet_acknowledgement(
            Context::new(),
            key,
            ack_commitment,
        ) {
    ...
    fn store_channel(
        ...
        match self.adapter.write().unwrap().set_channel(
            Context::new(),
            port_id,
            chan_id,
            channel_end.clone(),
    ...
    fn store_next_sequence_send(
        ...
        match self.adapter.write().unwrap().set_next_sequence_send(
            Context::new(),
            port_id,
            chan_id,
            seq,
    ...
    fn store_next_sequence_recv(
        ...
        match self.adapter.write().unwrap().set_next_sequence_recv(
            Context::new(),
            port_id,
            chan_id,
            seq,
    ...
    fn store_next_sequence_ack(
        ...
        match self.adapter.write().unwrap().set_next_sequence_ack(
            Context::new(),
            port_id,
            chan_id,
            seq,
    ...
    Adapter: IbcAdapter + 'static,
{
    ...
    fn get_packet_receipt(
        ...
        match self
            ...
            .read()
            .unwrap()
            .get_packet_receipt(Context::new(), key)
        {
            Ok(Some(r)) => Ok(r),
            _ => Err(ChannelError::implementation_specific()),
        }
    ...
    fn get_packet_acknowledgement(
        ...
        match self
            ...
            .read()
            .unwrap()
            .get_packet_acknowledgement(Context::new(), key)
        {
            Ok(Some(r)) => Ok(r),
            _ => Err(ChannelError::implementation_specific()),
        }
