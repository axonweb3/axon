...
// use protocol::traits::{
//     CommonConsensusAdapter, ConsensusAdapter, Context, MessageTarget,
// NodeInfo, };
// use protocol::types::{
//     Block, Bytes, ExecResp, Hash, Hasher, Header, Hex, Metadata,
// MetadataVersion, Pill, Proof,     Receipt, SignedTransaction, H256,
// };
...
//             height:     11,
//             round:      0,
//             block_hash: Bytes::from(block.header_hash().as_bytes().to_vec()),
...
// fn _init_engine(init_status: CurrentStatus) ->
// ConsensusEngine<MockConsensusAdapter> {     ConsensusEngine::new(
...
//         common_ref:
// Hex::from_string("0x703873635a6b51513451".to_string()).unwrap(),
//         timeout_gap:                20,
//         gas_limit:                  600000,
//         gas_price:                  1,
//         interval:                   3000,
...
//     async fn save_block(&self, _ctx: Context, _block: Block) ->
// ProtocolResult<()> {         Ok(())
//     }

//     async fn save_proof(&self, _ctx: Context, _proof: Proof) ->
// ProtocolResult<()> {         Ok(())
//     }
...
//     async fn get_block_by_number(&self, _ctx: Context, _number: u64) ->
// ProtocolResult<Block> {         unimplemented!()
//     }
...
//     async fn verify_block_header(&self, _ctx: Context, _block: &Block) ->
...
//     async fn broadcast_number(&self, _ctx: Context, _number: u64) ->
// ProtocolResult<()> {         Ok(())
//     }
...
//     fn tag_consensus(&self, _ctx: Context, _peer_ids: Vec<Bytes>) ->
// ProtocolResult<()> {         Ok(())
//     }
...
//     async fn sync_txs(&self, _ctx: Context, _txs: Vec<Hash>) ->
// ProtocolResult<()> {         Ok(())
//     }
...
//     async fn pull_block(&self, _ctx: Context, _number: u64, _end: &str) ->
// ProtocolResult<Block> {         unimplemented!()
//     }
...
//     async fn verify_txs(&self, _ctx: Context, _number: u64, _txs: &[Hash]) ->
// ProtocolResult<()> {         Ok(())
//     }
// }
