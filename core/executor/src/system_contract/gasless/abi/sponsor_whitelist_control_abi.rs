...
pub mod sponsor_whitelist_control {
    ...
    impl<M: ethers::providers::Middleware> SponsorWhitelistControl<M> {
        ...
        #[doc = "Calls the contract's `substractSponsorBalance` (0xa7a1ad09) function"]
        pub fn substract_sponsor_balance(
            &self,
            contract_addr: ethers::core::types::Address,
            balance: ethers::core::types::U256,
        ) -> ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([167, 161, 173, 9], (contract_addr, balance))
                .expect("method not found (this should never happen)")
        }
    }
    ...
    #[doc = "Container type for all input parameters for the `substractSponsorBalance` function with signature `substractSponsorBalance(address,uint256)` and selector `0xa7a1ad09`"]
    #[derive(
        Clone,
        Debug,
        Eq,
    ...
    #[ethcall(
        name = "substractSponsorBalance",
        abi = "substractSponsorBalance(address,uint256)"
    )]
    pub struct SubstractSponsorBalanceCall {
        pub contract_addr: ethers::core::types::Address,
    ...
    pub enum SponsorWhitelistControlCalls {
        ...
        SubstractSponsorBalance(SubstractSponsorBalanceCall),
    }
    impl ethers::core::abi::AbiDecode for SponsorWhitelistControlCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <SubstractSponsorBalanceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(SponsorWhitelistControlCalls::SubstractSponsorBalance(
                    decoded,
                ));
            }
    ...
    impl ethers::core::abi::AbiEncode for SponsorWhitelistControlCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                SponsorWhitelistControlCalls::SubstractSponsorBalance(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for SponsorWhitelistControlCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                SponsorWhitelistControlCalls::SubstractSponsorBalance(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ::std::convert::From<SubstractSponsorBalanceCall> for SponsorWhitelistControlCalls {
        fn from(var: SubstractSponsorBalanceCall) -> Self {
            SponsorWhitelistControlCalls::SubstractSponsorBalance(var)
        }
    }
