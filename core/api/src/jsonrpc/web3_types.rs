...
impl Web3TransactionOut {
    pub fn create(receipt: Receipt, stx: SignedTransaction) -> Web3TransactionOut {
        ...
        let web3_transaction_out_tx = Web3TransactionOut {
            ...
            input:                    Hex::encode(stx.transaction.unsigned.data).as_string(),
